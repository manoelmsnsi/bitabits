<?php class Administradores extends Controller {   
    private  $auth,$db;
...
//           $logs = new LogsModel();
//           $comando='/Administradores/admin_listar/';
...
//       } 
    ...
    public function form(){
        ...
        if($acesso->acesso_valida("/".__CLASS__."/admin_listar/")==true){
            $administradores= new AdministradoresModel();
            ...
            $menu = new MenuHelper("Bitabits - Desenvolvimento", $Class, $AcaoForm, $MetodoDeEnvio);       
               echo $menu->Menu();
                ...
                if(!empty($id)){
                    $administradores_dados=$administradores->listar_Administradores($join, "1", "id='$id'", $offset, $orderby, $camposfrom, $group);                                     
